class Conditional < ActiveRecord::Base
  ...
  has_many :conditional_antecedent_disjunctions, class_name: ConditionalAntecedentDisjunction, foreign_key: :conditional_id
  has_many :conditional_consequent_disjunctions, class_name: ConditionalConsequentDisjunction, foreign_key: :conditional_id
end
